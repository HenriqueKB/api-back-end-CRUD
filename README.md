...
Como já dizia o Goleiro Bruno, vamos por partes.
...
* OPCIONAL: pix no número 44 991428080 pra fazer um churrasco ou comer no Cantinho da Costela.
...
Para pesquisar os usuários, a recomendação é antes usar um GET para verificar todos e então pegar o ID de um usuário de sua escolha e testar.
Outros fil
